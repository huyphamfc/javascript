...
- Create an electric car object and experiment with calling 'accelerate', 'brake' and 'chargeBattery' (charge to 90%). Notice what happens when you 'accelerate'.
*/
...
const huy = new EV('HuyCar', 100, 80);
huy.chargeBattery(100);
huy.accelerate();